...
// console.log(recordUpdateData)
  ...
  return (
    <Main_list title={t("tableForms.categoriesTitle")}>
      {/* <MainPageCard> */}
      {open && (
        <CustomModal openCloseModal={setOpen} title={`${t("tableForms.add")} ${t("tableForms.categoryTitle")}`}>
      ...
      {open && editData?.id && (
        <CustomModal
          ...
          title={`${t("tableForms.edit")} ${t("tableForms.categoryTitle")}`}
