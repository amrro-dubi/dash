...
// console.log(recordUpdateData)
  ...
  const deleteSubmitHandler = useDeleteConfirmation({url:"admin/blog", inValid:'blogs'})
  ...
  return (
    <Main_list title={`${t('tableForms.blogsTitle')}`}>
       {open && (
        <CustomModal openCloseModal={setOpen} title={`${t('tableForms.add')} ${t('tableForms.blogTitle')}`}>
          <BlogsForm openCloseModal={setOpen} editData={null} />
        </CustomModal>
      )}
      {open && editData?.id && (
        <CustomModal
          openCloseModal={setOpen}
          title={`${t('tableForms.edit')} ${t('tableForms.blogTitle')}`}
          resetEditData={setEditData}
        >
          <BlogsForm editData={editData} resetEditData={setEditData} openCloseModal={setOpen} />
        </CustomModal>
      )}
      <ColumnChooser
        setPage={setPage}
