...
import homeImg from "../../assets/img/dashboard/icon/property-location-icon.svg";
...
export default function PropertyForm({
  ...
  const { data: developersRecordes, isSuccess: developerIsSuccess } =
    useGetRecordsQuery({
      url: "admin/developer",
      inValid: ["developers"],
    });
  const { data: categoriesRecordes, isSuccess: categoriesIsSuccess } =
    useGetRecordsQuery({
      url: "admin/category",
      inValid: ["categories"],
    });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formDataRequest.append(
      "locales[ar][payment_plan]",
      formData.payment_planAr
    );
    ...
    formDataRequest.append(
      "locales[en][payment_plan]",
      formData.payment_planEn
    );
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className=" lg:px-6 py-[50px]">
        <div className="add-property-wrapper relative p-4 md:mx-[30px] grid grid-cols-12">
          <div className="grid sm:gap-[40px] xl:gap-[100px] col-span-12 mb-4 grid-cols-12 add-property-content">
            <div className="grid grid-cols-12 col-span-12 gap-4">
              <div className=" col-span-12 lg:col-span-4">
                <div className="add-property-icon-content">
                  ...
                  <h6>Proprety Overview</h6>
                  <span />
                </div>
              </div>
              <div className=" col-span-12 xl:col-span-8 grid grid-cols-12 gap-4 bg-[#fafafa] p-5 rounded-[12px]">
              ...
              <div className="col-span-12 xl:col-span-8 grid grid-cols-12 gap-4 bg-[#fafafa] p-5 rounded-[12px]">
                ...
                <div className="lg:col-span-6 col-span-12">
                  <InputComponent
                    ...
                    placeholder={t(
                      "tableForms.placeholders.max_bathrooms_count"
                    )}
                ...
                <div className="lg:col-span-6 col-span-12">
                  <InputComponent
                    ...
                    placeholder={t(
                      "tableForms.placeholders.min_bathrooms_count"
                    )}
                  ...
                  <div className="lg:col-span-6 col-span-12">
                    <CustomDataInput
                      ...
                      onChange={(date) =>
                        setFormData({
                          ...formData,
                          handover_date: date as Date | null,
                        })
                      }
                    />
                  </div>
                    ...
                    <label className="inline-flex items-center me-5 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            has_studio: e.target.checked ? "1" : "0",
                          })
                        }
            ...
            <div className="grid grid-cols-12 col-span-12 gap-4">
              ...
              <div className="col-span-12 xl:col-span-8 grid grid-cols-12 gap-4 bg-[#fafafa] p-5 rounded-[12px] ">
              <div className=" col-span-12 lg:col-span-6 mt-7">
              <Upload_cover
                multi
