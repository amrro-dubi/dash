...
const dispatch  = useDispatch()
  ...
  <LoginModal/> */}
    ...
    <header className={`header-area style-1 dashboard-header ${openSidebar?"slide":""}`}>
    <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
      <div className="mobile-logo-wrap">
        <Link to="/"><a><img alt="image" src="/assets/img/logo.svg" /></a></Link>
      </div>
    </div>
    ...
    <ul className="menu-list">
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu">
            <li><Link to="/"><a>Home 01</a></Link></li>
            <li><Link to="/index2"><a>Home 02</a></Link></li>
            <li><Link to="/index3"><a>Home 03</a></Link></li>
            <li><Link to="/index4"><a>Home 04</a></Link></li>
            <li><Link to="/index5"><a>Home 05</a></Link></li>
            <li><Link to="/index6"><a>Home 06</a></Link></li>
          </ul>
        </li>
          ...
          <div className="mega-menu">
            <ul className="menu-row">
              <li className="menu-single-item">
                ...
                <ul>
                  <li><Link to="/property-list"><a>Houses (10)</a></Link></li>
                  <li><Link to="/property-list"><a>Industires (13)</a></Link></li>
                  <li><Link to="/property-list"><a>Home Twon (33)</a></Link></li>
                  <li><Link to="/property-list"><a>Development (15)</a></Link></li>
                  <li><Link to="/property-list"><a>Health Care (20)</a></Link></li>
                  <li><Link to="/property-list"><a>Office (10)</a></Link></li>
                  <li><Link to="/property-list"><a>Banglow (10)</a></Link></li>
                  <li><Link to="/property-list"><a>Hotel (10)</a></Link></li>
                  <li className="explore-more-btn">
                    <Link to="/property-list"><a>Explore More <i className="bi bi-arrow-right-short" /></a></Link>
                  </li>
                </ul>
              </li>
              <li className="menu-single-item">
                ...
                <ul>
                  <li><Link to="/property-list"><a>Panama City (10)<img src="/assets/img/menu-icon/panama.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>Sydne City (10)<img src="/assets/img/menu-icon/sydne.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>Melbourne City (10)<img src="/assets/img/menu-icon/melbourne.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>New Delhi (10)<img src="/assets/img/menu-icon/delhi.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>New York (10)<img src="/assets/img/menu-icon/newYork.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>Menchester City (10)<img src="/assets/img/menu-icon/menchester.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>City of Greece (10)<img src="/assets/img/menu-icon/greece.svg" alt="" /></a></Link></li>
                  <li><Link to="/property-list"><a>City of Abu-dabi (10)<img src="/assets/img/menu-icon/abudabi.svg" alt="" /></a></Link></li>
                  <li className="explore-more-btn">
                    <Link to="/property-list"><a>Explore More <i className="bi bi-arrow-right-short" /></a></Link>
                  </li>
                </ul>
                ...
                <div className="menu-insight">
                  ...
                  <div className="insight-wrap">
                    <div className="insights-content">
                      <h6><Link to="/blog-details"><a>The Rise of Remote Work: How It's Shaping Real Estate Trends</a></Link></h6>
                    </div>
                    <div className="insights-img">
                      <Link to="/blog-details"><a><img src="/assets/img/home1/insights-img.png" alt="" /></a></Link>
                    </div>
                    <div className="explore-more-btn">
                      <Link to="/blog-details"><a>Read Insight <i className="bi bi-arrow-right-short" /></a></Link>
                    </div>
                  </div>
                </div>
              </li>
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/property-list/deatils1"><a>Property Details 01</a></Link></li>
                <li><Link to="/poperty-deatils2"><a>Property Details 02</a></Link></li> 
              </ul>
            </li>
            <li>
              ...
              <i className="d-lg-none d-flex bi bi-plus dropdown-icon" />
              <ul className="sub-menu">
                <li><Link to="/property-list/left-sidebar"><a>Property Listing Left Sidebar</a></Link></li>
                <li><Link to="/property-list/right-sidebar"><a>Property Listing Right Sidebar</a></Link></li>
                <li><Link to="/property-list"><a>Property Listing No Sidebar</a></Link></li>
              </ul>
            </li>
            <li>
              ...
              <i className="d-lg-none d-flex bi bi-plus dropdown-icon" />
              <ul className="sub-menu">
                <li><Link to="/property-map/"><a>Property Map Left</a></Link></li>
                <li><Link to="/property-map/right"><a>Property Map Right</a></Link></li>
                <li><Link to="/property/top"><a>Property Map Top</a></Link></li>
              </ul>
            </li>
            <li><Link to="/special-offer"><a>Special Offer</a></Link></li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li><Link to="/shop/product-details"><a>Product Details</a></Link></li>
                <li><Link to="/shop/cart"><a>Cart</a></Link></li>
                <li><Link to="/shop/checkout"><a>Checkout</a></Link></li> 
              </ul>
            </li>
            <li>
              <a href="#">Blog</a>
              ...
              <i className="d-lg-none d-flex bi bi-plus dropdown-icon" />
              <ul className="sub-menu">
                <li><Link to="/blog/standard"><a>Blog Standard</a></Link></li>
                <li><Link to="/blog/details"><a>Blog  Details</a></Link></li> 
              </ul>
            </li>
            <li><Link to="/pricing-plan"><a>Pricing Plan</a></Link></li>
            <li><Link to="/pricing-checkout "><a>Pricing Checkout</a></Link></li>
            <li><Link to="/faq"><a>FAQ's</a></Link></li>
            <li><Link to="/error"><a>Error</a></Link></li>
            <li><Link to="/customer-review"><a>Customer Review </a></Link></li>
            <li><Link to="/return-enchange"><a>Return &amp; Exchange</a></Link></li>
          </ul>
        </li>
        <li>
          <Link to="/contact"><a  className="drop-down">CONTACT US</a></Link>
        </li>
      </ul>
    ...
    <div className="nav-right d-flex jsutify-content-end align-items-center">   
      ...
      <div className={`sidebar-button mobile-menu-btn ${openSidebar? "active":""}`} onClick={onToggleOpen}>
        <span />
      </div>
    </div>
    </header>
